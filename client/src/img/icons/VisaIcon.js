...
function VisaIcon(props) {
  return (
    ...
    >
      <path
        fill="#3C58BF"
        d="M184.8 324.4L210.4 180.4 250.4 180.4 225.6 324.4z"
      ></path>
      <path
        fill="#293688"
        d="M184.8 324.4L217.6 180.4 250.4 180.4 225.6 324.4z"
      ></path>
      <path
        fill="#3C58BF"
      ...
      ></path>
      <g fill="#051244">
        <path d="M151.2 276.4L124 249.2l-12.8 30.4-3.2-20c-7.2-24-30.4-50.4-56-63.2l36 128h43.2l20-48z"></path>
        <path d="M225.6 324.4L191.2 289.2 184.8 324.4z"></path>
        <path d="M317.6 274.8c3.2 3.2 4.8 5.6 4 8.8 0 9.6-12.8 14.4-24 14.4-16 0-24.8-2.4-38.4-8l-5.6-2.4-5.6 32.8c9.6 4 27.2 8 45.6 8 25.6 0 46.4-7.2 58.4-20l-34.4-33.6zM364 324.4h37.6l8-24h51.2l4.8 24H504L490.4 266l-48-46.4 2.4 12.8s8 36 9.6 44h-33.6c3.2-8 16-42.4 16-42.4s3.2-8.8 5.6-14.4"></path>
      </g>
    </svg>
  );
}
