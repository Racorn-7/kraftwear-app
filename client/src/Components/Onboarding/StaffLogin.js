...
import { loginStaff } from '../../Functions/liveUserAuth'
...
const StaffLogin = (props) => {
  ...
  useEffect(() => {
    setLoginTitle("Kraftwear office");
    setLoginSubTitle("Staff login page");
    return () => {
      //
    }
  }, [])
  ...
  const handleSubmit = async (e, d) => {
    ...
    setTimeout(() => {
      loginStaff(emailValue, passwordValue, setErrorMsg, setStaff, setIsLoading)
    }, (d) ? "3000" : "200"
    );
  }
